...
<div id="print">
	...
	<center>
		...
		<?php echo get_phrase('cell') . ' ' . $cell_name;?><br>
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            for ($i = 1; $i <= $days; $i++) {
                                ...
                                $attendance = $this->db->get_where('attendance', array('section_id' => $section_id, 'cell_id' => $cell_id, 'year' => $running_year, 'timestamp' => $timestamp, 'student_id' => $row['student_id']))->result_array();
