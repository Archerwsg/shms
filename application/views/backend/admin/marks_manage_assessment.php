...
<div class="row">
	...
	<div class="col-md-2">
		...
		<label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('assessment');?></label>
			<select name="assessment_id" class="form-control selectboxit">
				<?php
					$assessments = $this->db->get_where('assessment' , array('year' => $running_year ,'semester' => $semester))->result_array();
