...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(site_url('admin/tabulation_sheet_assessment'));?>
			<div class="col-md-4">
	...
	<div class="col-md-4" style="text-align: center;">
		...
		<div class="icon"><i class="entypo-docs"></i></div>
			...
			<h4 style="color: #696969;">
				<?php echo get_phrase('class') . ' ' . $class_name;?> : <?php echo $assessment_name;?>
			</h4>
		</div>
	</div>
	<div class="col-md-4"></div>
...
<div class="row">
	<div class="col-md-12">
		<table class="table table-bordered">
			...
			?>
				...
				?>
					<td style="text-align: center;">
						<?php 
							$obtained_mark_query = 	$this->db->get_where('assessment_marks' , array(
													'class_id' => $class_id , 
		...
		<center>
			<a href="<?php echo site_url('admin/tabulation_sheet_assessment_print_view/'.$class_id.'/'.$assessment_id);?>" 
