<?php 
	$edit_data = $this->db->get_where('carer' , array('carer_id' => $param2))->result_array();
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/carer/edit/'. $row['carer_id']) , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
