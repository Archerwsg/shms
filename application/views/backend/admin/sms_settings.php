	...
	<div class="col-md-12">
		...
		<div class="tabs-vertical-env">
			...
			<ul class="nav tabs-vertical">
				...
				<li>
					<a href="#v-zentech" data-toggle="tab">
						Zentech Settings
						<?php if ($active_sms_service == 'zentech'):?>
			...
			<div class="tab-content">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
							<select name="active_sms_service" class="form-control selectboxit">
								...
								<option value="zentech"
									<?php if ($active_sms_service == 'zentech') echo 'selected';?>>
										Zentech
                        		</option>
				...
				<div class="tab-pane" id="v-zentech">
					<?php echo form_open(site_url('admin/sms_settings/zentech') ,
						array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
						<div class="form-group">
	                      <label  class="col-sm-3 control-label"><?php echo get_phrase('zentech_username');?></label>
	                      	<div class="col-sm-5">
	                          	<input type="text" class="form-control" name="zentech_user"
	                            	value="<?php echo $this->db->get_where('settings' , array('type' =>'zentech_user'))->row()->description;?>" required>
	                      	</div>
	                  	</div>
	                  	<div class="form-group">
	                        <label  class="col-sm-3 control-label"><?php echo get_phrase('zentech_password');?></label>
	                        <div class="col-sm-5">
	                            <input type="text" class="form-control" name="zentech_password"
	                                value="<?php echo $this->db->get_where('settings' , array('type' =>'zentech_password'))->row()->description;?>" required>
	                        </div>
	                    </div>
	                    <div class="form-group">
	                      <label  class="col-sm-3 control-label"><?php echo humanize('zentech_sender_name');?></label>
	                        <div class="col-sm-5">
	                            <input type="text" class="form-control" name="zentech_sender_name" value="<?php echo $this->db->get_where('settings' , array('type' =>'zentech_sender_name'))->row()->description;?>" required>
	                        </div>
	                    </div>
	                    <div class="form-group">
		                    <div class="col-sm-offset-3 col-sm-5">
				...
				<div class="tab-pane" id="v-profile">
					<?php echo form_open(site_url('admin/sms_settings/twilio') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
						<div class="form-group">
