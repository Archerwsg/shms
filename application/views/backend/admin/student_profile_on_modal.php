...
<div class="profile-env">
	<header class="row">
		<div class="col-md-12" style="margin-bottom: 15px;">
			<center>
        <a href="#">
  				<img src="<?php echo $this->crud_model->get_image_url('member', $member_id) ;?>" class="img-circle" height="100px;"/>
  			</a>
        <br>
        <h4>
          <?php echo $row['name']; ?>
      ...
      <li class="">
        ...
        <?php } ?>
          ...
          <?php echo get_phrase('average_grade_point');?> :
           ...
           <br> <br>
           <a href="<?php echo site_url('admin/member_marksheet_print_view/'.$member_id.'/'.$row2['exam_id']);?>"
