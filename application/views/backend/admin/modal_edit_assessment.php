		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('edit_assessment');?>
            	</div>
            </div>
			<div class="panel-body">
				
                <?php echo form_open(site_url('admin/assessment/edit/do_update/'.$row['assessment_id'] ), array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            <div class="padded">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control" min="1" max="100" name="mark_total" value="<?php echo $row['mark_total'];?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
                      <button type="submit" class="btn btn-info"><?php echo get_phrase('edit_assessment');?></button>
                    </div>
                </div>
            </form>
            </div>
