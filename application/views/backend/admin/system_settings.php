    ...
    <?php echo form_open(site_url('admin/system_settings/do_update') ,
      array('class' => 'form-horizontal form-groups-bordered','target'=>'_top'));?>
        <div class="col-md-6">
            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('number_of_semester');?></label>
                      <div class="col-sm-9">
                          <input type="number" class="form-control" name="number_of_semester" value="<?php echo $this->db->get_where('settings' , array('type' =>'number_of_semester'))->row()->description;?>" required>
                      </div>
                  </div>
        ...
        <?php echo form_open(site_url('admin/system_settings/upload_logo') , array(
            ...
            <?php echo form_open(site_url('admin/system_settings/change_skin') , array(
            'class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
              ...
              <div class="col-md-6">
                <div class="panel panel-primary" >
                  ...
                  <div class="panel-heading">
                      <div class="panel-title">
                          <?php echo get_phrase('change_skin');?>
                      </div>
                  </div>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-3 control-label"><?php echo get_phrase('change_skin');?></label>
                        <div class="col-sm-9">
                            <select name="skin_colour" class="form-control selectboxit">
                            <option value="" disabled="true"> Change Skin Color </option>
                            <?php 
                                $skin_colour = $this->db->get_where('settings' , array('type'=>'skin_colour'))->row()->description;
                                foreach(file_names('/assets/css/skins') as $value){
                                    echo "<option ".(($skin_colour == $value) ? 'selected' : '' ).">".$value."</option>";
                                }
                            ?>
                            </select>
                        </div>
