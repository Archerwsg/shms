<?php
$edit_data		=	$this->db->get_where('usher' , array('usher_id' => $param2) )->result_array();
		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('edit_usher');?>
            	</div>
            </div>
			<div class="panel-body">
                    <?php echo form_open(site_url('admin/usher/do_update/'.$row['usher_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                                ...
                                <div class="col-sm-5">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                            <img src="<?php echo $this->crud_model->get_image_url('usher' , $row['usher_id']);?>" alt="...">
                                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo get_phrase('edit_usher');?></button>
                            </div>
                        </div>
                <?php echo form_close();?>
            </div>
