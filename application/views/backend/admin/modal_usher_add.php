		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('add_usher');?>
            	</div>
            </div>
			<div class="panel-body">

      <?php echo form_open(site_url('admin/usher/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                  ...
                  <option value="0"><?php echo get_phrase('no');?></option>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo get_phrase('add_usher');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
