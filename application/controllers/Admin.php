 ...
 *  Zen School Management System Pro
 *  http://zentechgh.com/user/zentech
 *  http://support.zentech.com
 */
class Admin extends MY_Controller
{
    ...
    function member_profile($member_id)
    {
        ...
        $page_data['page_name']  = 'member_profile';
        $page_data['page_title'] = get_phrase('member_profile');
        $page_data['member_id']  = $member_id;
        $this->load->view('backend/index', $page_data);
    }

    function get_sections($cell_id)
    {
        $page_data['cell_id'] = $cell_id;
    ...
    function member_information($cell_id = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');

        $page_data['page_name']      = 'member_information';
        $page_data['page_title']     = get_phrase('member_information') . " - " . get_phrase('cell') . " : " .
            $this->crud_model->get_cell_name($cell_id);
        $page_data['cell_id']     = $cell_id;
        $this->load->view('backend/index', $page_data);
    }

    function student_subjects($class_id = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');

        $page_data['page_name']      = 'student_subjects';
        $page_data['page_title']     = get_phrase('student_subjects') . " - " . get_phrase('class') . " : " .
            $this->crud_model->get_class_name($class_id);
        $page_data['class_id']     = $class_id;
        $this->load->view('backend/index', $page_data);
    }
    ...
    function student_report($student_id = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        $class_id     = $this->db->get_where('enroll', array(
    ...
    function member($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if (html_escape($this->input->post('age')) != null) {
                $data['age']        = html_escape($this->input->post('age'));
            }
            if (html_escape($this->input->post('occupation')) != null) {
                $data['occupation']        = html_escape($this->input->post('occupation'));
            }
            if ($this->input->post('carer_id') != null) {
                $data['carer_id']    = $this->input->post('carer_id');
            }
            if (html_escape($this->input->post('ministry')) != null) {
                $data['ministry']        = html_escape($this->input->post('ministry'));
            }
            if (html_escape($this->input->post('foundation_school')) != null) {
                $data['foundation_school']        = html_escape($this->input->post('foundation_school'));
            }
            if (html_escape($this->input->post('baptismal_status')) != null) {
                $data['baptismal_status']        = html_escape($this->input->post('baptismal_status'));
            }
            if (html_escape($this->input->post('associated_family_name')) != null) {
                $data['associated_family_name']        = html_escape($this->input->post('associated_family_name'));
            }
            if (html_escape($this->input->post('associated_family_phone')) != null) {
                $data['associated_family_phone']        = html_escape($this->input->post('associated_family_phone'));
            }
            if (html_escape($this->input->post('relationship')) != null) {
                $data['relationship']        = html_escape($this->input->post('relationship'));
            }
            if (html_escape($this->input->post('marital_status')) != null) {
                $data['marital_status']        = html_escape($this->input->post('marital_status'));
            }
            if (html_escape($this->input->post('tongues_speaking_status')) != null) {
                $data['tongues_speaking_status']        = html_escape($this->input->post('tongues_speaking_status'));
            }
            if (html_escape($this->input->post('member_code')) != null) {
                $data['member_code'] = html_escape($this->input->post('member_code'));
                $code_validation = code_validation_insert(html_escape($data['member_code']));
                if (!$code_validation) {
                    $this->session->set_flashdata('error_message', get_phrase('this_id_no_is_not_available'));
                    redirect(site_url('admin/member_add'), 'refresh');
                }
            }
            ...
            if ($validation == 1) {
                ...
                $data2['enroll_code']    = substr(md5(rand(0, 1000000)), 0, 7);
                if ($this->input->post('cell_id') != null) {
                    $data2['cell_id']       = $this->input->post('cell_id');
                }
                if ($this->input->post('section_id') != '') {
                    $data2['section_id'] = $this->input->post('section_id');
                }
        ...
        if ($param1 == 'do_update') {
            ...
            if ($this->input->post('tongues_speaking_status') != null) {
                $data['tongues_speaking_status']   = $this->input->post('tongues_speaking_status');
            }
            if ($this->input->post('baptismal_status') != null) {
                $data['baptismal_status']   = $this->input->post('baptismal_status');
            }
            if ($this->input->post('foundation_school') != null) {
                $data['foundation_school']   = $this->input->post('foundation_school');
            }
            if ($this->input->post('associated_family_name') != null) {
                $data['associated_family_name']   = $this->input->post('associated_family_name');
            }
            if ($this->input->post('associated_family_phone') != null) {
                $data['associated_family_phone']   = $this->input->post('associated_family_phone');
            }
            ...
            if ($this->input->post('ministry') != null) {
                $data['ministry']   = $this->input->post('ministry');
            }
            if ($this->input->post('hometown') != null) {
            ...
            if (html_escape($this->input->post('member_code')) != null) {
                $data['member_code'] = html_escape($this->input->post('member_code'));
                $code_validation = code_validation_update($data['member_code'], $param2);
                if (!$code_validation) {
                    $this->session->set_flashdata('error_message', get_phrase('this_id_no_is_not_available'));
                    redirect(site_url('admin/member_information/' . $param3), 'refresh');
                }
            }

            $validation = email_validation_for_edit($data['email'], $param2, 'member');
            if ($validation == 1) {
    ...
    function delete_member($member_id = '', $cell_id = '')
    {
        $this->crud_model->delete_member($member_id);
        $this->session->set_flashdata('flash_message', get_phrase('member_deleted'));
        redirect(site_url('admin/member_information/' . $cell_id), 'refresh');
    }
    ...
    function carer($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        if ($param1 == 'create') {
            ...
            $validation = email_validation($data['email']);
            if ($validation == 1) {
                $this->db->insert('carer', $data);
                $this->session->set_flashdata('flash_message', get_phrase('data_added_successfully'));
                $this->email_model->account_opening_email('carer', $data['email']); //SEND EMAIL ACCOUNT OPENING EMAIL
            } else {
                $this->session->set_flashdata('error_message', get_phrase('this_email_id_is_not_available'));
            }

            redirect(site_url('admin/carer'), 'refresh');
        }
        if ($param1 == 'edit') {
            $data['name']                   = html_escape($this->input->post('name'));
            $data['email']                  = html_escape($this->input->post('email'));
            ...
            $validation = email_validation_for_edit($data['email'], $param2, 'carer');
            if ($validation == 1) {
                $this->db->where('carer_id', $param2);
                $this->db->update('carer', $data);
                $this->session->set_flashdata('flash_message', get_phrase('data_updated'));
            } else {
                $this->session->set_flashdata('error_message', get_phrase('this_email_id_is_not_available'));
            }
        ...
        if ($param1 == 'delete') {
            $this->db->where('carer_id', $param2);
            $this->db->delete('carer');
            $this->session->set_flashdata('flash_message', get_phrase('data_deleted'));
            redirect(site_url('admin/carer'), 'refresh');
        }
        $page_data['page_title']     = get_phrase('all_carers');
        $page_data['page_name']  = 'carer';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function get_carers()
    {
        ...
        $totalData = $this->ajaxload->all_carers_count();
        $totalFiltered = $totalData;

        if (empty($this->input->post('search')['value'])) {
            $carers = $this->ajaxload->all_carers($limit, $start, $order, $dir);
        } else {
            $search = $this->input->post('search')['value'];
            $carers =  $this->ajaxload->carer_search($limit, $start, $search, $order, $dir);
            $totalFiltered = $this->ajaxload->carer_search_count($search);
        }
        ...
        if (!empty($carers)) {
            foreach ($carers as $row) {
                ...
                $options = '<div class="btn-group"><button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                    Action <span class="carer"></span></button><ul class="dropdown-menu dropdown-default pull-right" role="menu"><li><a href="#" onclick="carer_edit_modal(' . $row->carer_id . ')"><i class="entypo-pencil"></i>&nbsp;' . get_phrase('edit') . '</a></li><li class="divider"></li><li><a href="#" onclick="carer_delete_confirm(' . $row->carer_id . ')"><i class="entypo-trash"></i>&nbsp;' . get_phrase('delete') . '</a></li></ul></div>';

                $nestedData['carer_id'] = $row->carer_id;
                $nestedData['name'] = $row->name;
                $nestedData['email'] = $row->email;
                $nestedData['phone'] = $row->phone;
                $nestedData['profession'] = $row->profession;
    ...
    function usher($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        if ($param1 == 'create') {
            ...
            $validation = email_validation($data['email']);
            if ($validation == 1) {
                $this->db->insert('usher', $data);
                $usher_id = $this->db->insert_id();
                move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/usher_image/' . $usher_id . '.jpg');
                $this->session->set_flashdata('flash_message', get_phrase('data_added_successfully'));
                $this->email_model->account_opening_email('usher', $data['email']); //SEND EMAIL ACCOUNT OPENING EMAIL
            } else {
                $this->session->set_flashdata('error_message', get_phrase('this_email_id_is_not_available'));
            }

            redirect(site_url('admin/usher'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = html_escape($this->input->post('name'));
            $data['email']       = html_escape($this->input->post('email'));
            ...
            $validation = email_validation_for_edit($data['email'], $param2, 'usher');
            if ($validation == 1) {
                $this->db->where('usher_id', $param2);
                $this->db->update('usher', $data);
                move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/usher_image/' . $param2 . '.jpg');
                $this->session->set_flashdata('flash_message', get_phrase('data_updated'));
            } else {
                $this->session->set_flashdata('error_message', get_phrase('this_email_id_is_not_available'));
            }
            ...
            $page_data['personal_profile']   = true;
            $page_data['current_usher_id'] = $param2;
        } else if ($param1 == 'edit') {
            $page_data['edit_data'] = $this->db->get_where('usher', array(
                'usher_id' => $param2
            ))->result_array();
        }
        if ($param1 == 'delete') {
            $this->db->where('usher_id', $param2);
            $this->db->delete('usher');
            $this->session->set_flashdata('flash_message', get_phrase('data_deleted'));
            redirect(site_url('admin/usher'), 'refresh');
        }
        $page_data['ushers']   = $this->db->get('usher')->result_array();
        $page_data['page_name']  = 'usher';
        $page_data['page_title'] = get_phrase('manage_usher');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function get_ushers()
    {
        ...
        $totalData = $this->ajaxload->all_ushers_count();
        $totalFiltered = $totalData;

        if (empty($this->input->post('search')['value'])) {
            $ushers = $this->ajaxload->all_ushers($limit, $start, $order, $dir);
        } else {
            $search = $this->input->post('search')['value'];
            $ushers =  $this->ajaxload->usher_search($limit, $start, $search, $order, $dir);
            $totalFiltered = $this->ajaxload->usher_search_count($search);
        }
        ...
        if (!empty($ushers)) {
            foreach ($ushers as $row) {
                ...
                $photo = '<img src="' . $this->crud_model->get_image_url('usher', $row->usher_id) . '" class="img-circle" width="30" />';

                $options = '<div class="btn-group"><button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                    Action <span class="caret"></span></button><ul class="dropdown-menu dropdown-default pull-right" role="menu"><li><a href="#" onclick="usher_edit_modal(' . $row->usher_id . ')"><i class="entypo-pencil"></i>&nbsp;' . get_phrase('edit') . '</a></li><li class="divider"></li><li><a href="#" onclick="usher_delete_confirm(' . $row->usher_id . ')"><i class="entypo-trash"></i>&nbsp;' . get_phrase('delete') . '</a></li></ul></div>';

                $nestedData['usher_id'] = $row->usher_id;
                $nestedData['photo'] = $photo;
                $nestedData['name'] = $row->name;
                $nestedData['email'] = $row->email;
                $nestedData['phone'] = $row->phone;
    ...
    /****MANAGE CLASSES*****/
    function cells($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        if ($param1 == 'create') {
            $data['name']         = html_escape($this->input->post('name'));
            $data['usher_id']   = $this->input->post('usher_id');
            $data['zone_divisions_id']   = $this->input->post('zone_divisions_id');
            ...
            $data2['cell_id']  =   $cell_id;
            $data2['name']      =   '';
            $data2['usher_id'] = $data['usher_id'];

            $this->session->set_flashdata('flash_message', get_phrase('data_added_successfully'));
            redirect(site_url('admin/cells'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = html_escape($this->input->post('name'));
            $data['usher_id']   = $this->input->post('usher_id');
            ...
            $this->db->where('cell_id', $param2);
            $this->db->update('cell', $data);
            $this->session->set_flashdata('flash_message', get_phrase('data_updated'));
            redirect(site_url('admin/cells'), 'refresh');
        } else if ($param1 == 'edit') {
            $page_data['edit_data'] = $this->db->get_where('cell', array(
                'cell_id' => $param2
            ))->result_array();
        }
        if ($param1 == 'delete') {
        ...
        $page_data['cells']    = $this->db->get('cell')->result_array();
        $page_data['page_name']  = 'cell';
        $page_data['page_title'] = get_phrase('manage_cell');
        $this->load->view('backend/index', $page_data);
    }
    /****MANAGE Check as Validation*****/
    function ajax_checker_validator($value = '', $table = '', $col = '')
    {
        /**********Query data name */
        $checker = $this->db->get_where($table, array(
            $col => $value
        ))->num_rows();

        if ($checker) {
            echo "<i style='color:red;'>" . $value . " is already in use</i>";

            echo "<script>$('";
            echo ':input[type="submit"]';
            echo "').prop('disabled', true);</script>";
        } else {
            echo "<i style='color:green;'>" . $value . " is valid in use</i>";

            echo "<script>$('";
            echo ':input[type="submit"]';
            echo "').prop('disabled', false);</script>";
        }
    }


    function class_divisions($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        if ($param1 == 'create') {
            $data['name']         = html_escape($this->input->post('name'));
            $data['subject_specification']         = html_escape($this->input->post('subject_specification'));
            $data['class_assessment_mark']         = html_escape($this->input->post('class_assessment_mark'));
            $data['class_exam_mark']         = html_escape($this->input->post('class_exam_mark'));
            if ($this->input->post('name_numeric') != null) {
                $data['name_numeric'] = html_escape($this->input->post('name_numeric'));
            }
            $this->db->insert('class_divisions', $data);

            $this->session->set_flashdata('flash_message', get_phrase('data_added_successfully'));
            redirect(site_url('admin/class_divisions'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = html_escape($this->input->post('name'));
            $data['usher_id']   = $this->input->post('usher_id');
        ...
        $page_data['class_divisions']    = $this->db->get('class_divisions')->result_array();
        $page_data['page_name']  = 'class_divisions';
        $page_data['page_title'] = get_phrase('class_divisions');
        $this->load->view('backend/index', $page_data);
    }
    function zone_divisions($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        if ($param1 == 'create') {
            ...
            $this->db->insert('zone_divisions', $data);

            $this->session->set_flashdata('flash_message', get_phrase('data_added_successfully'));
            redirect(site_url('admin/zone_divisions'), 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = html_escape($this->input->post('name'));

            $this->db->where('id', $param2);
            $this->db->update('zone_divisions', $data);
            $this->session->set_flashdata('flash_message', get_phrase('data_updated'));
            redirect(site_url('admin/zone_divisions'), 'refresh');
        } else if ($param1 == 'edit') {
            $page_data['edit_data'] = $this->db->get_where('cell', array(
        ...
        if ($param1 == 'delete') {
            $this->db->where('id', $param2);
            $this->db->delete('zone_divisions');
            $this->session->set_flashdata('flash_message', get_phrase('data_deleted'));
            redirect(site_url('admin/zone_divisions'), 'refresh');
        }
        $page_data['zone_divisions']    = $this->db->get('zone_divisions')->result_array();
        $page_data['page_name']  = 'zone_divisions';
        $page_data['page_title'] = get_phrase('zone_divisions');
        $this->load->view('backend/index', $page_data);
    }
    ...
    /****MANAGE SECTIONS*****/
    function section($cell_id = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        // detect the first cell
        if ($cell_id == '')
            $cell_id           =   $this->db->get('cell')->first_row()->cell_id;
    ...
    function sections($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $validation = duplication_of_section_on_create($data['cell_id'], $data['name']);
            if ($validation == 1) {
            ...
            redirect(site_url('admin/section/' . $data['cell_id']), 'refresh');
        }
        ...
        if ($param1 == 'edit') {
            ...
            $validation = duplication_of_section_on_edit($param2, $data['cell_id'], $data['name']);
            if ($validation == 1) {
    ...
    function get_cell_section($cell_id)
    {
        $sections = $this->db->get_where('section', array(
            'cell_id' => $cell_id
        ))->result_array();
    ...
    function get_cell_section_selector($cell_id)
    {
        $page_data['cell_id'] = $cell_id;
        $this->load->view('backend/admin/get_cell_section_selector', $page_data);
    }
    ...
    function get_class_subjects($student_id, $class_id)
    {
        $subjects   = $this->db->get_where('subject', array(
            'class_id' => $class_id, 'year' => $this->db->get_where('settings', array('type' => 'running_year'))->row()->description
        ))->result_array();

        $students_subjects = json_decode($this->db->get_where('enroll', array(
            'student_id' => $student_id, 'year' => $this->db->get_where('settings', array('type' => 'running_year'))->row()->description
        ))->row()->subjects, true);
        $students_subjects = $students_subjects === null ? null : $students_subjects;

        foreach ($subjects as $row) {
            echo '<div class="checkbox">
                <label><input type="checkbox" class="check" name="subject_id[]" value="' . $row['subject_id'] . '" ' . ($students_subjects !== null ? in_array($row['subject_id'], $students_subjects) ? "checked" : "" : "checked") . '>' . $row['name'] . '</label>
            </div>';
        }
    ...
    function get_class_subject_mass($class_id)
    {
        $subjects   = $this->db->get_where('subject', array(
            'class_id' => $class_id, 'year' => $this->db->get_where('settings', array('type' => 'running_year'))->row()->description
        ))->result_array();
    ...
    function get_students_subjects($class_id, $subject_id)
    {
        $students = $this->db->get_where('enroll', array(
            'class_id' => $class_id, 'year' => $this->db->get_where('settings', array('type' => 'running_year'))->row()->description
        ))->result_array();
        ...
        echo '<div class="form-group">
                ...
                <div class="col-sm-9">';
        foreach ($students as $row) {
            $students_for_students = $row['subjects'] == null ? null : json_decode($row['subjects'], true);
            $name = $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->name;
            echo '<div class="checkbox">
                    <label><input type="checkbox" class="check" name="student_id[]" value="' . $row['student_id'] . '" ' . ($students_for_students !== null ? in_array($subject_id, $students_for_students) ? "checked" : "" : "checked") . '>' . $name . '</label>
                </div>';
        }
        echo '<br><button type="button" class="btn btn-default" onClick="select()">' . get_phrase('select_all') . '</button>';
        echo '<button style="margin-left: 5px;" type="button" class="btn btn-default" onClick="unselect()"> ' . get_phrase('select_none') . ' </button>';
        ...
        echo '<div class="form-group">
            <div class="col-sm-5">
                <button type="submit" class="btn btn-info submit">' . get_phrase('save') . '</button>
            </div>
        </div>';
    }
    ...
    function assessment($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $data['mark_total']    = html_escape($this->input->post('mark_total'));
            $data['year']    = $this->db->get_where('settings', array('type' => 'running_year'))->row()->description;
            $data['semester']    = $this->db->get_where('settings', array('type' => 'semester'))->row()->description;
            if ($this->input->post('comment') != null) {
                $data['comment'] = html_escape($this->input->post('comment'));
            }
            $this->db->insert('assessment', $data);
            $this->session->set_flashdata('flash_message', get_phrase('data_added_successfully'));
            redirect(site_url('admin/assessment'), 'refresh');
        }
        if ($param1 == 'create_mass_generator') {
            $start = new DateTime(html_escape($this->input->post('date')));
            $days = (int)html_escape($this->input->post('date_interval'));
            for ($x = (int)$this->input->post('post_number_min'); $x <= (int)$this->input->post('post_number_max'); $x++) {

                if ($x !== $this->input->post('post_number_min')) {
                    $inv = 'P' . $days . 'D';
                    $start->add(new DateInterval($inv));
                }
                ...
                $data['name']    = html_escape($this->input->post('prefix_name')) . '-' . $x;
                $data['date']    = html_escape($start->format('d/m/Y'));
                $data['mark_total']    = html_escape($this->input->post('mark_total'));
                $data['year']    = $this->db->get_where('settings', array('type' => 'running_year'))->row()->description;
                $data['semester']    = $this->db->get_where('settings', array('type' => 'semester'))->row()->description;
                if ($this->input->post('comment') != null) {
        ...
        if ($param1 == 'edit' && $param2 == 'do_update') {
            ...
            $this->db->where('assessment_id', $param3);
        ...
        $page_data['assessments']      = $this->db->get_where('assessment', array('year' => $running_year, 'semester' => $semester))->result_array();
        $page_data['page_name']  = 'assessment';
        $page_data['page_title'] = get_phrase('manage_assessment');
        $this->load->view('backend/index', $page_data);
    }


    function marks_manage_assessment()
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        $page_data['page_name']  =   'marks_manage_assessment';
        $page_data['page_title'] = get_phrase('manage_assessment_marks');
        var_dump($page_data);
        die();
        $this->load->view('backend/index', $page_data);
    }
    ...
    function exam($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $running_year = $this->db->get_where('settings', array('type' => 'running_year'))->row()->description;
        $page_data['exams']      = $this->db->get_where('exam', array('year' => $running_year, 'semester' => $semester))->result_array();
    ...
    function marks_manage_view_assessment($assessment_id = '', $class_id = '', $section_id = '', $subject_id = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        ...
        $page_data['subject_id'] =   $subject_id;
        $page_data['section_id'] =   $section_id;
        $page_data['page_name']  =   'marks_manage_view_assessment';
        $page_data['page_title'] = get_phrase('manage_assessment_marks');
        $this->load->view('backend/index', $page_data);
    }
        ...
        if ($data['class_id'] != '' && $data['exam_id'] != '') {
            ...
            if ($query->num_rows() < 1) {
                ...
                foreach ($students as $row) {
                    ...
                    } else if (in_array($data['subject_id'], json_decode($row['subjects']))) {
                        $data['student_id'] = $row['student_id'];
                        $this->db->insert('mark', $data);
                    }
                }
    ...
    function marks_selector_assessment()
    {
        ...
        $data['assessment_id']    = $this->input->post('assessment_id');
        $data['class_id']   = $this->input->post('class_id');
        $data['section_id'] = $this->input->post('section_id');
        $data['subject_id'] = $this->input->post('subject_id');
        $data['year']       = $this->db->get_where('settings', array('type' => 'running_year'))->row()->description;
        $data['semester']       = $this->db->get_where('settings', array('type' => 'semester'))->row()->description;
        if ($data['class_id'] != '' && $data['assessment_id'] != '') {
            $query = $this->db->get_where('assessment_marks', array(
            ...
            if ($query->num_rows() < 1) {
                ...
                foreach ($students as $row) {
                    if ($row['subjects'] == NULL) {
                        $data['mark_total'] = $this->db->get_where('assessment', array('assessment_id' => $this->input->post('assessment_id')))->row()->mark_total;
                        $data['student_id'] = $row['student_id'];
            ...
            redirect(site_url('admin/marks_manage_view_assessment/' . $data['assessment_id'] . '/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['subject_id']), 'refresh');
        } else {
            $this->session->set_flashdata('error_message', get_phrase('select_all_the_fields'));
            $page_data['page_name']  =   'marks_manage_assessment';
            $page_data['page_title'] = get_phrase('manage_assessment_marks');
    ...
    function marks_update_assessment($assessment_id = '', $class_id = '', $section_id = '', $subject_id = '')
    {
        if ($class_id != '' && $assessment_id != '') {
            ...
            foreach ($marks_of_students as $row) {
                $mark_total = $this->db->get_where('assessment', array('assessment_id' => $assessment_id))->row()->mark_total;
                $obtained_marks = html_escape($this->input->post('marks_obtained_' . $row['mark_id']));
                $comment = html_escape($this->input->post('comment_' . $row['mark_id']));
                $this->db->where('mark_id', $row['mark_id']);
                $this->db->update('assessment_marks', array('mark_obtained' => $obtained_marks, 'comment' => $comment, 'mark_total' => $mark_total));
            }
            $this->session->set_flashdata('flash_message', get_phrase('marks_updated'));
            redirect(site_url('admin/marks_manage_view_assessment/' . $assessment_id . '/' . $class_id . '/' . $section_id . '/' . $subject_id), 'refresh');
        } else {
            $this->session->set_flashdata('error_message', get_phrase('select_all_the_fields'));
            $page_data['page_name']  =   'marks_manage_assessment';
            $page_data['page_title'] = get_phrase('manage_assessment_marks');
    ...
    // TABULATION SHEET
    function tabulation_sheet_assessment($class_id = '', $assessment_id = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        if ($this->input->post('operation') == 'selection') {
            $page_data['assessment_id']    = html_escape($this->input->post('assessment_id'));
            $page_data['class_id']   = html_escape($this->input->post('class_id'));

            if ($page_data['assessment_id'] > 0 && $page_data['class_id'] > 0) {
                redirect(site_url('admin/tabulation_sheet_assessment/' . $page_data['class_id'] . '/' . $page_data['assessment_id']), 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose class and assignment');
                redirect(site_url('admin/tabulation_sheet_assessment'), 'refresh');
            }
        }
        $page_data['assessment_id']     = $assessment_id;
        $page_data['class_id']          = $class_id;

        $page_data['page_info']         = 'assignment marks';

        $page_data['page_name']         = 'tabulation_sheet_assessment';
        $page_data['page_title']        = get_phrase('tabulation_sheet_assessment');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function tabulation_sheet_assessment_print_view($class_id, $assessment_id)
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        $page_data['class_id'] = $class_id;
        $page_data['assessment_id']  = $assessment_id;
        $this->load->view('backend/admin/tabulation_sheet_assessment_print_view', $page_data);
    }
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $validation = duplication_of_cell_routine_on_create($array);
            if ($validation == 1) {
        ...
        if ($param1 == 'do_update') {
            ...
            if ($data['subject_id'] != '') {
                ...
                $validation = duplication_of_cell_routine_on_edit($array, $param2);
    ...
    function manage_attendance_view($cell_id = '', $section_id = '', $timestamp = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        ...
        $page_data['section_id'] = $section_id;
        $page_data['page_title'] = get_phrase('manage_attendance_of_cell') . ' ' . $cell_name . ' : ' . get_phrase('section') . ' ' . $section_name;
        $this->load->view('backend/index', $page_data);
    }
    function get_section($cell_id)
    {
        $page_data['cell_id'] = $cell_id;
    ...
    function attendance_selector()
    {
        ...
        if ($query->num_rows() < 1) {
            $members = $this->db->get_where('enroll', array(
                'cell_id' => $data['cell_id'], 'section_id' => $data['section_id'], 'year' => $data['year']
            ))->result_array();

            foreach ($members as $row) {
                $attn_data['cell_id']   = $data['cell_id'];
                $attn_data['year']       = $data['year'];
                $attn_data['timestamp']  = $data['timestamp'];
                $attn_data['section_id'] = $data['section_id'];
                $attn_data['member_id'] = $row['member_id'];
                $this->db->insert('attendance', $attn_data);
            }
        }
        redirect(site_url('admin/manage_attendance_view/' . $data['cell_id'] . '/' . $data['section_id'] . '/' . $data['timestamp']), 'refresh');
    }

    function attendance_update($cell_id = '', $section_id = '', $timestamp = '')
    {
        $running_year = $this->db->get_where('settings', array('type' => 'running_year'))->row()->description;
        $active_sms_service = $this->db->get_where('settings', array('type' => 'active_sms_service'))->row()->description;
        $attendance_of_members = $this->db->get_where('attendance', array(
            'cell_id' => $cell_id, 'section_id' => $section_id, 'year' => $running_year, 'timestamp' => $timestamp
        ))->result_array();
        foreach ($attendance_of_members as $row) {
            ...
            if ($attendance_status == 2) {
                ...
                if ($active_sms_service != '' || $active_sms_service != 'disabled') {
                    $member_name   = $this->db->get_where('member', array('member_id' => $row['member_id']))->row()->name;
                    $parent_id      = $this->db->get_where('member', array('member_id' => $row['member_id']))->row()->parent_id;
                    $message        = 'Your child' . ' ' . $member_name . 'is absent today.';
        ...
        redirect(site_url('admin/manage_attendance_view/' . $cell_id . '/' . $section_id . '/' . $timestamp), 'refresh');
    }

    /****** DAILY ATTENDANCE *****************/
    function manage_attendance2($date = '', $month = '', $year = '', $cell_id = '', $section_id = '', $session = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(site_url('login'), 'refresh');
        ...
        if ($_POST) {
            // Loop all the members of $cell_id
            ...
            $members = $this->db->get('enroll')->result_array();
            foreach ($members as $row) {
                $attendance_status  =   $this->input->post('status_' . $row['member_id']);

                $this->db->where('member_id', $row['member_id']);
                $this->db->where('date', $date);
                $this->db->where('year', $year);
                $this->db->where('cell_id', $row['cell_id']);
                ...
                if ($attendance_status == 2) {
                    ...
                    if ($active_sms_service != '' || $active_sms_service != 'disabled') {
                        ...
                        $receiver_phone = $this->db->get_where('carer', array('carer_id' => $carer_id))->row()->phone;
                        $message        = 'Your child' . ' ' . $member_name . 'is absent today.';
                        $this->sms_model->send_sms($message, $receiver_phone);
                    }
                }
            ...
            $this->session->set_flashdata('flash_message', get_phrase('data_updated'));
            redirect(site_url('admin/manage_attendance/' . $date . '/' . $month . '/' . $year . '/' . $cell_id . '/' . $section_id . '/' . $session), 'refresh');
        }
        $page_data['date']       =    $date;
    ...
    function attendance_report_view($cell_id = '', $section_id = '', $month = '', $sessional_year = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(base_url(), 'refresh');

        $cell_name                     = $this->db->get_where('cell', array('cell_id' => $cell_id))->row()->name;
        ...
        $page_data['page_title']        = get_phrase('attendance_report_of_cell') . ' ' . $cell_name . ' : ' . get_phrase('section') . ' ' . $section_name;
        $this->load->view('backend/index', $page_data);
    }
    function attendance_report_print_view($cell_id = '', $section_id = '', $month = '', $sessional_year = '')
    {
        if ($this->session->userdata('admin_login') != 1)
            redirect(base_url(), 'refresh');
    ...
    {
        if ($this->input->post('cell_id') == '' || $this->input->post('sessional_year') == '') {
            $this->session->set_flashdata('error_message', get_phrase('please_make_sure_cell_and_sessional_year_are_selected'));
        ...
        redirect(site_url('admin/attendance_report_view/' . $data['cell_id'] . '/' . $data['section_id'] . '/' . $data['month'] . '/' . $data['sessional_year']), 'refresh');
    }
    ...
    function subject_allocation($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'individual') {
            ...
            $data['subjects']         = json_encode($this->input->post('subject_id'));
        ...
        if ($param1 == 'create_mass_subject') {
            $all_students_in_class = $this->db->get_where('enroll', array(
                'class_id' => $this->input->post('class_id'), 'year' => $running_year
            ))->result_array();
            ...
            foreach ($all_students_in_class as $student) {
                ...
                $student['subjects']                = $student['subjects'] == null ? json_encode(array_map(function ($value) {
                    return $value['subject_id'];
                }, $all_subjects_for_students)) : $student['subjects'];
                $subject_id                         = $this->input->post('subject_id');
                $student_id                         = $student['student_id'];
                $studeents_included_in_subjects     = $this->input->post('student_id') == null ? array() : $this->input->post('student_id');
                $include                            = in_array($student_id, $studeents_included_in_subjects);
                $subject_with_student               = in_array($subject_id, json_decode($student['subjects'], true));

                if ($include) {
                    if ($subject_with_student) {
                        $data['subjects'] = $student['subjects'];
                    } else {
                        $data['subjects'] = json_encode(array_merge(array((int)$subject_id), json_decode($student['subjects'], true)));
                    }
                } else {
                    if ($subject_with_student) {
                        // Remove subjects ID
                        $data['subjects'] = json_decode($student['subjects'], true);
                        unset($data['subjects'][array_search($subject_id, $data['subjects'])]);
                        $data['subjects'] = json_encode($data['subjects']);
                    } else {
                        // Remain Data(Do nothing)
                        $data['subjects'] = $student['subjects'];
                    }
                }
        ...
        redirect(site_url('admin/student_subjects'), 'refresh');
    }
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $data['description'] = html_escape($this->input->post('number_of_semester'));
            $this->db->where('type', 'number_of_semester');
            $this->db->update('settings', $data);
    ...
    function frontend_themes()
    {
        ...
        if ($_POST) {
            $data['description'] = html_escape($this->input->post('theme'));
            $this->db->where('type', 'theme');
            $this->db->update('frontend_general_settings', $data);
            $this->session->set_flashdata('flash_message', get_phrase('theme_selected'));
        }
        $page_data['theme'] = $this->frontend_model->get_frontend_general_settings('theme');
    ...
    {
        $this->load->view('backend/admin/change_semester');
    }
    ...
    {
        $data['description'] = $this->input->post('semester');
        $this->db->where('type', 'semester');
        $this->db->update('settings', $data);
        $this->session->set_flashdata('flash_message', get_phrase('semester_changed'));
        redirect(site_url('admin/dashboard'), 'refresh');
    }
    ...
    function sms_settings($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'zentech') {
            ...
            $data['description'] = html_escape($this->input->post('zentech_password'));
            $this->db->where('type', 'zentech_password');
            $this->db->update('settings', $data);

            $data['description'] = html_escape($this->input->post('zentech_user'));
            $this->db->where('type', 'zentech_user');
            $this->db->update('settings', $data);

            $data['description'] = html_escape($this->input->post('zentech_sender_name'));
            $this->db->where('type', 'zentech_sender_name');
            $this->db->update('settings', $data);
