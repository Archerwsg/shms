...
if ( ! function_exists('duplication_of_section_on_create')){
	function duplication_of_section_on_create($cell_id, $section_name){
		$ci=& get_instance();
		$num_rows = 0;
		$data = array(
		'cell_id' => $cell_id,
...
if ( ! function_exists('duplication_of_section_on_edit')){
	function duplication_of_section_on_edit($section_id, $cell_id, $section_name){
		$ci=& get_instance();
		$num_rows = 0;
		$data = array(
		'cell_id' => $cell_id,
...
// cell routine duplication on create
if ( ! function_exists('duplication_of_cell_routine_on_create')){
	function duplication_of_cell_routine_on_create($data){
		$ci=& get_instance();
		$num_rows = 0;
		$ci->db->where($data);
		$num_rows = $ci->db->get('cell_routine')->num_rows();
		if($num_rows == 0){
			return 1;
		}
		else if($num_rows > 1){
...
// cell routine duplication on edit
if ( ! function_exists('duplication_of_cell_routine_on_edit')){
	function duplication_of_cell_routine_on_edit($data, $cell_routine_id){
		$ci=& get_instance();
		$num_rows = 0;
		$ci->db->where_not_in('cell_routine_id', $cell_routine_id);
		$ci->db->where($data);
		$num_rows = $ci->db->get('cell_routine')->num_rows();
		if($num_rows == 0){
			return 1;
