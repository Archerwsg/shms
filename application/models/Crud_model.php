...
class Crud_model extends CI_Model {
    ...
    function get_members($cell_id) {
        $query = $this->db->get_where('member', array('cell_id' => $cell_id));
        return $query->result_array();
    }
    ...
    function get_member_info_by_id($member_id) {
        $query = $this->db->get_where('member', array('member_id' => $member_id ))->row_array();
        return $query;
    }
    ...
    function get_cell_name($cell_id) {
        $query = $this->db->get_where('cell', array('cell_id' => $cell_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['name'];
    }
    ...
    function get_cell_name_numeric($cell_id) {
        $query = $this->db->get_where('cell', array('cell_id' => $cell_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['name_numeric'];
...
//        $this->email_model->notify_email('new_message_notification', $this->db->insert_id());
    ...
    function delete_member($member_id){
        $tables = array('member', 'enroll');
        $this->db->delete($tables, array('member_id' => $member_id));
