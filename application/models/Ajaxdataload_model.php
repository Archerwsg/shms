...
class Ajaxdataload_model extends CI_Model
{
    ...
    function all_ushers_count()
    {
        $query = $this->db->get('usher');
        return $query->num_rows();
    }
    function all_ushers($limit, $start, $col, $dir)
    {   
       $query = $this
                ->db
                ->limit($limit,$start)
    ...
    function usher_search($limit, $start, $search, $col, $dir)
    {
        $query = $this
                ->db
                ->like('usher_id', $search)
                ->or_like('name', $search)
    ...
    function usher_search_count($search)
    {
        $query = $this
                ->db
                ->like('usher_id', $search)
    ...
    function all_carers_count()
    {
        $query = $this->db->get('carer');
        return $query->num_rows();
    }
    ...
    function all_carers($limit, $start, $col, $dir)
    {   
       $query = $this
                ->db
                ->limit($limit,$start)
    ...
    function carer_search($limit, $start, $search, $col, $dir)
    {
        $query = $this
                ->db
                ->like('carer_id', $search)
                ->or_like('name', $search)
                ->or_like('email', $search)
                ->or_like('phone', $search)
                ->or_like('profession', $search)
    ...
    function carer_search_count($search)
    {
        $query = $this
                ->db
                ->like('carer_id', $search)
